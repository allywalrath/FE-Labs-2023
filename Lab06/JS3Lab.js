 ...
 * Array 
 * Built-in methods:
    Built-in objects and built-in methods are related concepts in JavaScript, but
    they are not the same thing. They represent different components of the language's structure: 

    Built-in Objects: These are predefined data structures that store related data and functionality. 
    Examples include Array, String, Date, and Math. These objects have properties (values) and methods 
    (functions) associated with them [1].

    Built-in Methods: These are functions that are associated with a specific built-in object and perform 
    an action on the data within that object. For example, toUpperCase() is a built-in method of the String 
    object, and push() is a built-in method of the Array object [1]. 

    In short, a built-in object is a container of related data and functions, while a built-in method is one of 
    the specific functions inside that object [1].
 ...
 * Step 2: Convert the elements of the array into a string (with no spaces between the letters) and 
 print it to the console (See documentation: 
 https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/join)
 * 
 * 
 * ↓ YOUR CODE HERE ↓ */
 
let reversed = alphabetArray.reverse();
 ...
 * Step 6: Print the last element again. Did it change from earlier? Are you able to get the last 
...
console.log("Step 4:", array1.push(16, 3)); //.push will show the number of items in the array
console.log(array1); //printing updated array will show the items
...
/*
 * Using the provided code above, you will do multiple tasks. Print results to the console after 
   every change to the array(s).
 * Step 1: Create a variable called myToDoList that holds an empty array 
 * Step 2: Add three to-do items (elements) to the array using a built-in array method, then print 
   myToDoList to the console (See documentation: 
   https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/push)
 * Step 3: Remove the second element in the array, print the array to the console
 * Step 4: Create another array called yourToDoList, add two to-do items, and print the array to the 
   console
 * Step 5: Create another array called ourToDoList, then concatenate (combine) myToDoList and 
   yourToDoList into the array ourToDoList, there's more than one way to do this.(See documentation: 
   https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/concat  OR  
...
console.log("Step 2:", myToDoList.push("read", "write", "do homework")); //.push will show only the number of items in the array
console.log(myToDoList); //will show 'read', 'write', 'do homework'

console.log("Step 3:", myToDoList.splice(2, 1)); //just shows 'do homework' in the console bc that's what its removing
console.log(myToDoList); //shows what we have left ('read', 'do homework')
 ...
 * Step 1:  Create a function called "isEven"(See documentation: )
        ...
        * Hint: use the % operator to determine if a number is even or odd (See documentation: 
 ...
 * Hint: use a for loop to iterate through the array and add each element to a variable that holds the 
...
function addingMachine(x) {
  ...
  for(let i = 0; i < x.length; i++) {
    sum = sum + x[i]; //can also write "sum += x[i];" -- means the same thing a
  }
  /*as the for loop loops through the array and adds up all the numbers, it will 
  keep saving them into the variable sum. The next step is to return it (below)*/
 ...
 * Step 1: Create a function called "reverse" (See documentation: )
        ...
        * If it's an array, return the reversed array with each element reversed (i.e. ['hello', 'world'] 
        becomes ['dlrow', 'olleh'])
...
function reverse(x) {
  if (typeof x === 'boolean') {
    ...
    return x.toString().split('').reverse().join(''); //add quotes for join or it will add commas
  } else if (typeof x === 'string') {
    return x.split('').reverse().join('');
  } else if (Array.isArray(x)) { //add the x parameter into parentheses
    return x.reverse();
  } else {
    return false;
  }
...
/*
 * Step 1:  Create a function called removeElements - the purpose of this function is to remove all 
elements from an array
        ...
        * Within the body of the loop, use the pop() method (pop removes the last element in an array and returns that element)
...
/*
 * Step 1:  Create a function called whichArrayIsLonger. The purpose of this function is to 
determine which array has the most elements
